...
#ifndef RTLIB_CORE_STM32F1_GPIOV2_H_
#define RTLIB_CORE_STM32F1_GPIOV2_H_
 ...
 */
 ...
 private:
  ...
  constexpr std::uint32_t GetPortMemMapping() const { return PERIPH_BASE_APB2 + 0x0800 + std::uint32_t(0x0400 * std::uint8_t(pin_.first)); }
...
#endif  // RTLIB_CORE_STM32F1_GPIOV2_H_
